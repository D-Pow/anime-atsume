...
public class KissanimeRuService {
    ...
    private static final String COOKIE_GETTER_URL = "https://cookie-getter.herokuapp.com/kissanimeCookie";

    public HttpCookie getAuthCookie() {
        ResponseEntity<CookieResponse> cookieGetterResponse = new RestTemplate().exchange(
            COOKIE_GETTER_URL,
            HttpMethod.GET,
